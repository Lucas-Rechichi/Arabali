...
urlpatterns = [
    ...
    path('search/<str:query>/<int:increment>', main_v.search_results, name="search_results"),
    ...
    path('universal/check-modulation-time/', universal.check_modulation_time, name='check_modulation_time'),
