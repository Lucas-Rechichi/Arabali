...
def get_image_upload_path_message(instance, filename):
    ...
    return os.path.join('Rooms/', instance.name , 'message_images/' , instance.sender.user.username , filename)

def get_video_upload_path_message(instance, filename):

    return os.path.join('Rooms/', instance.name , 'message_videos/' , instance.sender.user.username , filename)
